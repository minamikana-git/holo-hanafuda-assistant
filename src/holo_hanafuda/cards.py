...
class Card:
    ...
    tag: str = ""  # e.g. "rain","sake","boar","deer","butterfly","moon","cherry","poetry-red","blue","plain"
...
def parse_card(token: str) -> Card:
    ...
    tag = tag.lower()
    # synonyms
    syn = {"bright":"bright","hikari":"bright","animal":"animal","tane":"animal","ribbon":"ribbon","tan":"ribbon","kasu":"kasu"}
    kind = syn.get(kind, kind)
    tag_syn = {
        "rain":"rain","sake":"sake","moon":"moon","cherry":"cherry",
        "boar":"boar","deer":"deer","butterfly":"butterfly",
        "red":"poetry-red","poetry":"poetry-red","blue":"blue","plain":"plain"
    }
